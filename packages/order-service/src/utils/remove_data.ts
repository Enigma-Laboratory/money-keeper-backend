...
route.delete('/users', async (req: Request, res: Response, next: NextFunction): Promise<void> => {
  try {
...
route.delete('/orders', async (req: Request, res: Response, next: NextFunction): Promise<void> => {
  try {
...
route.delete('/order-details', async (req: Request, res: Response, next: NextFunction): Promise<void> => {
  try {

...
export async function getAllOrderDetailHandler(
  req: Request,
  res: Response,
  next: NextFunction
): Promise<void> {
...
export async function getOneOrderDetailHandler(
  req: Request,
  res: Response,
  next: NextFunction
): Promise<void> {
  try {
    const orderDetail = await OrderDetailUseCases.deleteOneOrderDetail(
      req.params
    );
...
export async function createOneOrderDetailHandler(
  req: Request,
  res: Response,
  next: NextFunction
): Promise<void> {
...
export async function updateOrderDetailHandler(
  ...
  try {
    const orderDetail = await OrderDetailUseCases.updateOneOrderDetail(
      req.body
    );
    res.status(200).send(orderDetail);
  } catch (error: any) {
...
export async function deleteOneOrderDetailHandler(
  req: Request,
  res: Response,
  next: NextFunction
): Promise<void> {

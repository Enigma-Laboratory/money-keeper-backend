...
export async function createOneOrderHandler(
  req: Request,
  res: Response,
  next: NextFunction
): Promise<void> {
...
export async function getOrderDetailByOrderIdHandler(
  req: Request,
  res: Response,
  next: NextFunction
): Promise<void> {
...
export async function updateOneOrderHandler(
  req: Request,
  res: Response,
  next: NextFunction
): Promise<void> {
...
export async function updateOrderEventHandler(
  req: Request,
  res: Response,
  next: NextFunction
): Promise<void> {

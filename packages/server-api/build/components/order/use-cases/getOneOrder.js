...
exports.getOneOrder = void 0;
const order_model_1 = __importDefault(require("@/models/order.model"));
const transformedData_1 = require("@/shared/transformedData");
const shared_1 = require("@enigma-laboratory/shared");
const validation_1 = require("../validation");
function getOneOrder(params) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const validate = validation_1.OrderValidation.instance.getOneOrderValidate(params);
            if (validate.error)
                throw new shared_1.BadRequestError(validate.error.message);
            const order = yield order_model_1.default.findOne(params).lean().exec();
            if (!order)
                throw new shared_1.BadRequestError(`Can not get one order with id = ${params._id}`);

...
exports.deleteOneOrder = void 0;
const order_model_1 = __importDefault(require("@/models/order.model"));
const shared_1 = require("@enigma-laboratory/shared");
const validation_1 = require("../validation");
function deleteOneOrder(params) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const validate = validation_1.OrderValidation.instance.deleteOneOrderValidate(params);
            if (validate.error)
                throw new shared_1.BadRequestError(validate.error.message);
            const deleted = yield order_model_1.default.deleteOne(params);
